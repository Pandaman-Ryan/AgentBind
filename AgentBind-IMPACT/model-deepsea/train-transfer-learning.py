    ...
    def start_train(self):
        with tf.Graph().as_default():
            ...
            loader = tf.train.Saver({\
                    ...
                    u'conv2/weights/ExponentialMovingAverage':\
                            tf.get_default_graph().get_tensor_by_name(u'conv2/weights:0'),\
                    u'conv2/biases/ExponentialMovingAverage':\
                            tf.get_default_graph().get_tensor_by_name(u'conv2/biases:0'),\
                    u'conv3/weights/ExponentialMovingAverage':\
                            tf.get_default_graph().get_tensor_by_name(u'conv3/weights:0'),\
                    u'conv3/biases/ExponentialMovingAverage':\
                            tf.get_default_graph().get_tensor_by_name(u'conv3/biases:0')})
            '''
            ...
            loader = tf.train.Saver({\
                    ...
                    u'conv1/biases/ExponentialMovingAverage':\
                            tf.get_default_graph().get_tensor_by_name(u'conv1/biases:0'),\
                    u'conv1/batch_normalization/beta/ExponentialMovingAverage':\
                        tf.get_default_graph().get_tensor_by_name(u'conv1/batch_normalization/beta:0'),\
                    u'conv1/batch_normalization/gamma/ExponentialMovingAverage':\
                        tf.get_default_graph().get_tensor_by_name(u'conv1/batch_normalization/gamma:0'),\
                    u'conv2/weights/ExponentialMovingAverage':\
                            tf.get_default_graph().get_tensor_by_name(u'conv2/weights:0'),\
                    u'conv2/biases/ExponentialMovingAverage':\
                            tf.get_default_graph().get_tensor_by_name(u'conv2/biases:0'),\
                    u'conv2/batch_normalization/beta/ExponentialMovingAverage':\
                        tf.get_default_graph().get_tensor_by_name(u'conv2/batch_normalization/beta:0'),\
                    u'conv2/batch_normalization/gamma/ExponentialMovingAverage':\
                        tf.get_default_graph().get_tensor_by_name(u'conv2/batch_normalization/gamma:0'),\
                    u'conv3/weights/ExponentialMovingAverage':\
                            tf.get_default_graph().get_tensor_by_name(u'conv3/weights:0'),\
                    u'conv3/biases/ExponentialMovingAverage':\
                            tf.get_default_graph().get_tensor_by_name(u'conv3/biases:0'),\
                    u'conv3/batch_normalization/beta/ExponentialMovingAverage':\
                        tf.get_default_graph().get_tensor_by_name(u'conv3/batch_normalization/beta:0'),\
                    u'conv3/batch_normalization/gamma/ExponentialMovingAverage':\
                        tf.get_default_graph().get_tensor_by_name(u'conv3/batch_normalization/gamma:0')})
