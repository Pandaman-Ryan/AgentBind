...
def main():
    ...
    parser.add_option('--motif', dest='f_core_motif',
            default="/storage/pandaman/project/AgentBind-GM12878-DeepSEA-unfixed/storage/AgentBind-GM12878-DeepSEA/data/table_matrix/table_core_motifs.txt",
    ...
    parser.add_option('--workdir', dest='dir_work',
            default='/storage/pandaman/project/AgentBind-GM12878-DeepSEA-unfixed/storage/AgentBind-GM12878-DeepSEA/tmp/',
    ...
    parser.add_option('--datadir', dest='dir_data',
            default='/storage/pandaman/project/AgentBind-GM12878-DeepSEA-unfixed/storage/AgentBind-GM12878-DeepSEA/data/',
    ...
    parser.add_option('--resultdir', dest='dir_result',
            default='/storage/pandaman/project/AgentBind-GM12878-DeepSEA-unfixed/storage/AgentBind-GM12878-DeepSEA/results/',
            help='The directory where all input and dependent data are stored [Default: %default]')
