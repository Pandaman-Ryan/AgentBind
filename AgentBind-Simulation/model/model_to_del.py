...
class AgentBind():
    ...
    def infer(self, samples, training, trainable_conv_layers=True):
        ...
        conv1 = self._conv_layer(inputs=samples, scope_name='conv1',
                        filter_width=11, in_channels=4, out_channels=50, conv_stride=2,
                        pool_op=False, training=training,
                        trainable_parameters=trainable_conv_layers, record='conv')
        conv2 = self._conv_layer(inputs=conv1, scope_name='conv2',
                        filter_width=11, in_channels=50, out_channels=50, conv_stride=4,
                        pool_op=False, training=training,
                        trainable_parameters=trainable_conv_layers, record=None)
        #conv3 = self._conv_layer(inputs=conv2, scope_name='conv3',
        #                filter_width=8, in_channels=512, out_channels=256, conv_stride=2,
        #                pool_op=False, training=training,
        #                trainable_parameters=trainable_conv_layers)
        #conv4 = self._conv_layer(inputs=conv3, scope_name='conv4',
        #                filter_width=8, in_channels=256, out_channels=256, conv_stride=2,
        #                pool_op=False, training=training,
        #                trainable_parameters=trainable_conv_layers)
        #conv5 = self._conv_layer(inputs=conv4, scope_name='conv5',
        #                filter_width=8, in_channels=256, out_channels=128, conv_stride=2,
        #                pool_op=False, training=training,
        #                trainable_parameters=trainable_conv_layers)
        conv_final = conv2
    ...
    def _conv_layer(self, inputs, scope_name,
                    ...
                    training=None, trainable_parameters=None, record=None):
        """
        conv1d parameters:
